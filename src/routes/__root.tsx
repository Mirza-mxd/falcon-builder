...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Falcon Smart Solutions | Odoo Partner & ERP for Saudi SMEs" },
      {
        name: "description",
        content:
          "ZATCA-compliant, Arabic-native ERP. Falcon Desktop, Falcon Cloud and certified Odoo services for businesses across MENA.",
      },
      { property: "og:title", content: "Falcon Smart Solutions | Odoo Partner & ERP for Saudi SMEs" },
      {
      ...
      { name: "twitter:title", content: "Falcon Smart Solutions | Odoo Partner & ERP for Saudi SMEs" },
      { name: "description", content: "Certified Odoo Partner in Saudi Arabia. ERP implementation, ZATCA Phase 2 compliance, and AI automation for SMEs from 10 to 80 employees. Get a quote." },
      { property: "og:description", content: "Certified Odoo Partner in Saudi Arabia. ERP implementation, ZATCA Phase 2 compliance, and AI automation for SMEs from 10 to 80 employees. Get a quote." },
      { name: "twitter:description", content: "Certified Odoo Partner in Saudi Arabia. ERP implementation, ZATCA Phase 2 compliance, and AI automation for SMEs from 10 to 80 employees. Get a quote." },
